...
# ╔═╡ 1954317c-b18d-4da1-a404-a1e5a2507359
begin 
	using Markdown
	using InteractiveUtils
end

# ╔═╡ 36125a1c-454e-4059-922b-9453b3468121
begin
	using Images
	using Statistics
	using FFTW
...
# ╔═╡ f809ef6d-977a-44a3-9497-c6dfd9015ff1
md"""
# Functional definition
"""

# ╔═╡ c4ee8ca1-f89c-49a6-8b61-d4172f07888b
function decimate(arr, ratio=5)
	return arr[1:ratio:end, 1:ratio:end]
end

# ╔═╡ d8c0625c-ef88-4693-ba44-526948f61d08
...
# ╔═╡ a4e2a22b-8806-429a-80a0-042c346c2ded
...
# ╔═╡ 81b29ff8-2555-4f44-a1cf-e79940a0c4ff
convolve(dog, kernel)
